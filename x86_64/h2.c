...
#define nrn_init _nrn_init__h2
#define _nrn_initial _nrn_initial__h2
#define nrn_cur _nrn_cur__h2
#define _nrn_current _nrn_current__h2
#define nrn_jacob _nrn_jacob__h2
#define nrn_state _nrn_state__h2
#define _net_receive _net_receive__h2 
#define rate rate__h2 
#define states states__h2 
...
#define taul taul_h2
 double taul = 0;
#define vhalft vhalft_h2
 double vhalft = -75;
#define zetat zetat_h2
 double zetat = 2.2;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "cvodeieq");
 	...
 	ivoc_help("help ?1 h2 /home/dhh/soltesz-lab/qan-hfo/v2-7272021/x86_64/h2.mod\n");
...
{
 { error =  states();
 if(error){fprintf(stderr,"at line 49 in file h2.mod:\n	SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/dhh/soltesz-lab/qan-hfo/v2-7272021/h2.mod";
static const char* nmodl_file_text = 
